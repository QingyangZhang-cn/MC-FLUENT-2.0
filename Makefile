...
$(exe):main.cpp SortOut.o ReadFR.o rewritepower.o ModifyMate.o filestat.o RMSE.o submit.o
	$(cc) $(cflags) -o $(exe) main.cpp SortOut.o ReadFR.o rewritepower.o ModifyMate.o filestat.o RMSE.o submit.o $(clibs)
...
submit.o: submit.cpp submit.h
	$(cc) $(cflags) -c submit.cpp submit.h $(clibs)
